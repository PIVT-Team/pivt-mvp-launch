...
const DEMO_DOCUMENTS = [
  {
    file_name: 'Merger_Agreement_DataStream_v4.pdf',
    file_size: 2450000,
    mime_type: 'application/pdf',
    doc_type: 'spa',
    doc_type_confidence: 0.97,
    page_count: 84,
    extracted_text: 'AGREEMENT AND PLAN OF MERGER by and among APEX CAPITAL PARTNERS LLC ("Buyer"), DATASTREAM TECHNOLOGIES INC. ("Company"), and DATASTREAM HOLDINGS LLC ("Seller Representative"). Purchase Price: $2,800,000,000. Closing Date: March 15, 2026. Escrow Amount: $280,000,000 (10% of Purchase Price). Governing Law: Delaware. Indemnification Cap: $140,000,000. Basket Amount: $14,000,000.',
    extracted_fields: { buyer: 'Apex Capital Partners LLC', seller: 'DataStream Technologies Inc.', purchase_price: '$2,800,000,000', closing_date: 'March 15, 2026', escrow_amount: '$280,000,000', governing_law: 'Delaware', indemnification_cap: '$140,000,000' },
    validation_flags: [{ severity: 'info', field: 'escrow_amount', message: 'Escrow = 10% of purchase price — standard range' }],
  },
  {
    file_name: 'CapTable_DataStream_Final.xlsx',
    file_size: 890000,
    mime_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
    doc_type: 'cap_table',
    doc_type_confidence: 0.99,
    page_count: 3,
    extracted_text: 'DataStream Technologies Cap Table. Sarah Chen: 30% (840M). Marcus Williams: 20% (560M). Sequoia Capital Fund XIV: 15% (420M). Andreessen Horowitz: 10% (280M). Tiger Global: 8% (224M). Employee Option Pool: 7% (196M). Index Ventures: 6% (168M). GIC Private Limited: 4% (112M). Total: 100%.',
    extracted_fields: { shareholders: [{ name: 'Sarah Chen', ownership_pct: 30, payout: 840000000 }, { name: 'Marcus Williams', ownership_pct: 20, payout: 560000000 }, { name: 'Sequoia Capital Fund XIV', ownership_pct: 15, payout: 420000000 }, { name: 'Andreessen Horowitz', ownership_pct: 10, payout: 280000000 }, { name: 'Tiger Global', ownership_pct: 8, payout: 224000000 }, { name: 'Employee Option Pool', ownership_pct: 7, payout: 196000000 }, { name: 'Index Ventures', ownership_pct: 6, payout: 168000000 }, { name: 'GIC Private Limited', ownership_pct: 4, payout: 112000000 }], total_ownership: 100, total_payout: 2800000000 },
  ...
  },
  {
    ...
    page_count: 2,
    extracted_text: 'Distribution Waterfall Schedule. Tier 1: Senior Secured Debt $280M (10%). Tier 2: Transaction Expenses $84M (3%). Tier 3: Escrow Holdback $280M (10%). Tier 4: Preferred Return $560M (20%). Tier 5: Common Distribution $1,596M (57%). Total: $2,800M.',
    extracted_fields: { tiers: [{ name: 'Senior Secured Debt', amount: 280000000, pct: 10 }, { name: 'Transaction Expenses', amount: 84000000, pct: 3 }, { name: 'Escrow Holdback', amount: 280000000, pct: 10 }, { name: 'Preferred Return', amount: 560000000, pct: 20 }, { name: 'Common Distribution', amount: 1596000000, pct: 57 }], total: 2800000000 },
    validation_flags: [{ severity: 'info', field: 'total', message: 'Waterfall total ($2.8B) matches SPA purchase price' }],
  },
  {
  ...
  {
    file_name: 'Board_Resolutions_DataStream.pdf',
    file_size: 520000,
    mime_type: 'application/pdf',
    doc_type: 'board_consent',
    doc_type_confidence: 0.92,
    page_count: 12,
    extracted_text: 'UNANIMOUS WRITTEN CONSENT OF THE BOARD OF DIRECTORS OF DATASTREAM TECHNOLOGIES, INC. Resolved: That the Board approves the merger with Apex Capital Partners. Resolved: That the officers are authorized to execute the Merger Agreement. Date: January 8, 2026.',
